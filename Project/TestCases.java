...
public class TestCases {
	...
	static void arithmeticExpressioTest() {
		...
		System.out.println(e1 + " + (" + e2 + " / " + e5 + ") = "
				+ new AddExpression(e1, new DivisionExpression(e2, e5).execute()).execute());
	...
	static void conditionalExpression() {
		...
		System.out
				.println(x1 + " " + equalOp + " " + x2 + " = " + new ConditionalExpression(x1, x2, equalOp).getValue());
		System.out.println(two + "*" + x1 + " " + equalOp + " " + x2 + " = "
				+ new ConditionalExpression(new MultiplyExpression(two, x1), x2, equalOp).getValue());
		System.out.println("");
	}
